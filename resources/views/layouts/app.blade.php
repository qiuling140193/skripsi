...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      @if( Auth::user()->level == 1 )
        ...
        <li><a href="{{ route('forecasting.index') }}"><i class="fa fa-gears"></i> <span>Forecasting</span></a></li>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      Sistem Penjualan dan Pendukung Keputusan
    </div>
    <strong>Copyright &copy; 2018 <a href="#">Kilang Padi DT.AA</a>.</strong> 
  </footer>
  <!-- End Footer -->
