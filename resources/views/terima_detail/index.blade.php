...
{{ csrf_field() }}  
  ...
  <div class="form-group">
      <label for="kode" class="col-md-2 control-label">No Nota</label>
      <div class="col-md-5">
        <div class="input-group">
          <input id="kode" type="text" class="form-control" name="kode" autofocus required>
          <span class="input-group-btn">
            <button onclick="showPenjualan()" type="button" class="btn btn-info">...</button>
          </span>
        </div>
      </div>
  </div>
...
<tbody></tbody>
  ...
  <div class="col-md-8">
     <div id="#" style="background: #00000; color: #fff; font-size: 80px; text-align: center; height: 120px"></div>
     <div id="#" style="background: #00000; color: #fff; font-size: 25px; padding: 10px"></div>
  </div>
  <div class="col-md-4">
    <form class="form form-horizontal form-penjualan" method="post" action="transaksi/simpan">
      {{ csrf_field() }}
      <input type="hidden" name="idterima" value="{{ $idterima }}">
      <input type="hidden" name="total" id="total">
      <input type="hidden" name="nota_bayar" id="nota_bayar">

      <div class="form-group">
        <label for="totalrp" class="col-md-4 control-label">Total Bayar</label>
        <div class="col-md-8">
