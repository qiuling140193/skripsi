...
<tbody></tbody>
  ...
  <div class="col-md-8">
     <div id="tampil-bayar" style="background: #00000; color: #fff; font-size: 80px; text-align: center; height: 100px"></div>
     <div id="tampil-terbilang" style="background: #00000; color: #fff; font-weight: bold; padding: 10px"></div>
  </div>
  <div class="col-md-4">
